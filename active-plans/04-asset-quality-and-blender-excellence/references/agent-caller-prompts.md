...
Plan-specific focus:
- verify this plan creates a real visual quality contract instead of vague taste language
- check that screenshot/render proof and truthful Blender limits are explicit
- confirm the plan does not quietly assume paid assets or GUI-only workflows

## planimplementer
{{COMMON_PLANIMPLEMENTER}}

Plan-specific focus:
- implement the visual rubric, proof requirements, Blender support matrix, and distilled design guidance
- keep the distinction between style choice and quality failure clear
- preserve truthful support limits for Blender-derived workflows

## planprreviewer methodology
{{COMMON_PR_REVIEW_METHODOLOGY}}

Plan-specific review focus:
- look for subjective or untestable quality checks masquerading as blockers
- verify screenshot/render evidence is integrated into real validation paths

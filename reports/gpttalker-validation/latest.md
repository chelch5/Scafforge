...
- generated_at: `2026-04-06T15:09:08.636587+00:00`
- source_repo_path: `/tmp/scafforge-gpttalker-fixture-vwjteaot/restart-surface-drift-after-repair`

## Source Repo State

```text
git status unavailable for /tmp/scafforge-gpttalker-fixture-vwjteaot/restart-surface-drift-after-repair: fatal: not a git repository (or any of the parent directories): .git
```

...
- generated_at: `2026-04-16T19:31:10.564597+00:00`
- source_repo_path: `/tmp/scafforge-gpttalker-fixture-w_4o36md/restart-surface-drift-after-repair`

## Source Repo State

```text
git status unavailable for /tmp/scafforge-gpttalker-fixture-w_4o36md/restart-surface-drift-after-repair: fatal: not a git repository (or any of the parent directories): .git
```

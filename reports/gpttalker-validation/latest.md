...
- generated_at: `2026-04-13T22:24:43.132091+00:00`
- source_repo_path: `/tmp/scafforge-gpttalker-fixture-w9dayhob/restart-surface-drift-after-repair`

## Source Repo State

```text
git status unavailable for /tmp/scafforge-gpttalker-fixture-w9dayhob/restart-surface-drift-after-repair: fatal: not a git repository (or any of the parent directories): .git
```

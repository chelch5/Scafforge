...
- `artifact_write` does not edit repo files, docs, source, assets, tickets, or configuration. Use normal write-capable tools for those paths, then use `artifact_write` only to record evidence of the change.
